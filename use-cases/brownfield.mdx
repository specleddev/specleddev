...
4. Run `npx specled verify` to surface missing coverage and weak spots.
...
Run npx specled verify and list missing coverage.
```
...
Run npx specled verify and report what is not covered yet.
```

...
5. Use the guided reconcile step for your stack to see whether the current change lands in covered territory or on the uncovered frontier. In `specled_ex`, that is `mix spec.assist`.
6. Run the local report to surface missing coverage and weak spots.
7. Tighten one gap at a time.

...
4. Run spec verification to surface missing coverage and weak spots.
...
Run spec verification and list missing coverage.
```
...
Run spec checks and report what is not covered yet.
```

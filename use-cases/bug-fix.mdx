...
5. Run `npx specled verify`, `npx specled check`, and tests before merge.
...
Run npx specled verify and tests, then summarize drift findings.
```
...
Run npx specled verify and report any missing coverage.
```

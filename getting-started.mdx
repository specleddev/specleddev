...
3. Make the smallest code, docs, or test change that matters.
4. Add or tighten the smallest proof when behavior changed.
5. Run the guided reconcile step for your stack. In `specled_ex`, that is `mix spec.assist`.
6. Update one current-truth subject and run the strict check.

...
The best first step is one subject, one verification loop, and one clear piece of behavior that matters.

A good first pass looks like this: choose one subject, write current truth, tie it to real evidence, and run the check before you widen the scope.

## The shortest path

1. Choose one important subject.
2. Add the `.spec` workspace with the tooling for your stack.
3. Write one current-truth subject spec.
4. Tie it to real evidence.
5. Run the local verification command and fix drift before you widen the scope.
...
- adding a lot of process before you have one working verification loop

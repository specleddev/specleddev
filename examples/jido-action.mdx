...
description: "A deeper package example for the richer form of the method."
---

`jido_action` is the first package being used to refine Spec Led.

This is not the simplest starter path.

It is a deeper example that helps test how the method grows in a real package.
